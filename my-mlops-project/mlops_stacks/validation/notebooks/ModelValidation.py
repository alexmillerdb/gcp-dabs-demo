...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops-stacks/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops-stacks/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text("model_name", "dev.main.mlops-stacks-model", "Full (Three-Level) Model Name")
