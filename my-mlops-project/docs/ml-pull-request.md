...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-stacks-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://416411475796958.8.gcp.databricks.com#mlflow/models/staging-mlops-stacks-model)
* [Prod workspace registered model](https://416411475796958.8.gcp.databricks.com#mlflow/models/prod-mlops-stacks-model)
